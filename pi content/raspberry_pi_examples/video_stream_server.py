...
IMPORTANT:
- Use this standalone script only for stream-only testing.
- Do NOT run this together with smart_fire_main.py (camera busy conflict).
- For production, prefer smart_fire_main.py single-process mode.
"""
